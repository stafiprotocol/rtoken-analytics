...
export default function Index(props:any){
    ...
    useEffect(()=>{
        dispatch(getRToken(Rtoken.rDot));
    ...
    return <div>
          <DataRow>
          <DataCol title={"STAKED DOT VALUE"} unit="$" amount={data?NumberUtil.handleFisAmountToFixed(data.info.nativePrice*ratio*totalIssuance):"--"} toolTip={"test"}/>
        ...
        <DataRow>
            ...
            <ChartCol data={data?data.list.stakeValue.data:[]} xData={data?data.list.stakeValue.yData:[]} title="STAKED DOT VALUE" barColor={BarColor.left}/>
            <ChartCol data={data?data.list.reddemValue.data:[]} xData={data?data.list.reddemValue.yData:[]} title="REDEEM DOT VALUE" barColor={BarColor.right}/>
            <ChartCol data={data?data.list.rtokenValue.data:[]} xData={data?data.list.rtokenValue.yData:[]} title="rDOT VALUE" barColor={BarColor.left}/>
