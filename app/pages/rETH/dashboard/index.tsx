...
export default function Index(props:any){
    ...
    return <div>
          <DataRow>
          <DataCol title={"STAKED rETH VALUE"} unit="$" amount={data?NumberUtil.handleFisAmountToFixed(data.info.rtokenPrice*totalStakedAmount):"--"}   toolTip={"test"}/>
        ...
        <DataRow>
            ...
            <ChartCol data={data?data.list.stakeValue.data:[]} xData={data?data.list.stakeValue.yData:[]} title="STAKED rETH VALUE IN STAFI PER WEEK" barColor={BarColor.right}/>
