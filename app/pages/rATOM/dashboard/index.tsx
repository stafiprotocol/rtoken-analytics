...
export default function Index(props:any){
    ...
    return <div>
        ...
        <DataRow>
            <ChartCol data={data?data.list.rate.data:[]} xData={data?data.list.rate.yData:[]} title="rATOM : ATOM  RATE" barColor={"#40CB92"}/>
            <ChartCol data={data?data.list.price.data:[]} xData={data?data.list.price.yData:[]} title="rATOM PRICE" barColor={"#ED3C9A"}/>
            <ChartCol data={data?data.list.mint.data:[]} xData={data?data.list.mint.yData:[]} title="MINTED rATOM (NATIVE)" barColor={"#40CB92"}/>
            <ChartCol data={data?data.list.erc20Mint.data:[]} xData={data?data.list.erc20Mint.yData:[]} title="MINTED rATOM (ERC20)" barColor={"#ED3C9A"}/>
            <ChartCol data={data?data.list.stakeValue.data:[]} xData={data?data.list.stakeValue.yData:[]} title="STAKED rATOM VALUE IN STAFI PER WEEK" barColor={"#40CB92"}/>
            <ChartCol data={data?data.list.reddemValue.data:[]} xData={data?data.list.reddemValue.yData:[]} title="REDEEM rATOM VALUE IN STAFI PER WEEK" barColor={"#ED3C9A"}/>
            <ChartCol data={data?data.list.rtokenValue.data:[]} xData={data?data.list.rtokenValue.yData:[]} title="rATOM VALUE IN STAFI PER WEEK" barColor={"#40CB92"}/>
